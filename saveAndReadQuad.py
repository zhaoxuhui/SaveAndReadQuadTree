...
if __name__ == '__main__':
    ...
    # 第二层
    nodes.append((cvtPosStrToFullQuadCodeStr("11"), 100))
    nodes.append((cvtPosStrToFullQuadCodeStr("12"), 100))
    nodes.append((cvtPosStrToFullQuadCodeStr("13"), 100))
    nodes.append((cvtPosStrToFullQuadCodeStr("14"), 100))
    # 第三层第一部分
    nodes.append((cvtPosStrToFullQuadCodeStr("1101"), 100))
    nodes.append((cvtPosStrToFullQuadCodeStr("1102"), 100))
    ...
    nodes.append((cvtPosStrToFullQuadCodeStr("1302"), 100))
    nodes.append((cvtPosStrToFullQuadCodeStr("1303"), 100))
    nodes.append((cvtPosStrToFullQuadCodeStr("1304"), 100))
    ...
    img_tree = drawTree(tree, nodes)
    cv2.imwrite("quadtree.png", img_tree)
    img_nodes = drawNodes(tree, showNone=True)
